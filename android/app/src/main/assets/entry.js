...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixins = __webpack_require__(27);
	...
	var vm = new Vue(Vue.util.extend({ el: '#root',
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "D:\\MM\\weex\\WeexExample\\src\\index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function data() {
	    var root = (typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' ? 'dist/web' : 'vue';
	    return {
	      items: [
	      // common
	      { name: 'views/Counter', title: 'Hello' }, { name: root + '/syntax/hello-world', title: 'Hello World' }, { name: root + '/style/index', title: 'Common Style' }, { name: root + '/animation', title: 'Animation' },

	      // component
	      { name: root + '/components/text', title: 'Text' }, { name: root + '/components/image', title: 'Image' }, { name: root + '/components/input', title: 'Input' }, { name: root + '/components/scroller', title: 'Scroller' }, { name: root + '/components/list', title: 'List' }, { name: root + '/components/slider', title: 'Slider' }, { name: root + '/components/a', title: 'A' }, { name: root + '/components/video', title: 'Video' }, { name: root + '/components/countdown', title: 'Countdown' }, { name: root + '/components/marquee', title: 'Marquee' }, { name: root + '/components/web', title: 'Web' }, { name: root + '/components/navigator', title: 'Navigator' }, { name: root + '/components/tabbar', title: 'Tabbar' },
	      ...
	      // showcase
	      { name: root + '/showcase/progress', title: 'Progress Bar' }, { name: root + '/showcase/itemlist', title: 'List (Advanced)' }, { name: root + '/showcase/calculator', title: 'Calculator' }]
	    };
	  },
	  components: {
	    exampleList: __webpack_require__(1)
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutationTypes = __webpack_require__(22);
...
/***/ function(module, exports) {
	...
	var Counter_Increment_IFODD = exports.Counter_Increment_IFODD = 'Counter_Increment_IFODD';
	var Counter_Increment_ASYNC = exports.Counter_Increment_ASYNC = 'Counter_Increment_ASYNC';
	var Counter_evenOrOdd = exports.Counter_evenOrOdd = 'Counter_evenOrOdd';
	var Counter_GetCount = exports.Counter_GetCount = 'Counter_GetCount';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = (_mutations = {}, _defineProperty(_mutations, types.Counter_Increment, function (state) {
	    state.count++;
	}), _defineProperty(_mutations, types.Counter_Decrement, function (state) {
	    state.count--;
	}), _mutations);
	...
	var actions = {
	    ...
	    incrementAsync: function (_incrementAsync) {
	        function incrementAsync(_x) {
	            return _incrementAsync.apply(this, arguments);
	        }

	        incrementAsync.toString = function () {
	            return _incrementAsync.toString();
	        };
