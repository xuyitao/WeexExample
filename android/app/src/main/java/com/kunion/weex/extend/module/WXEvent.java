package com.kunion.weex.extend.module;
...
public class WXEvent extends WXModule {

    private static final String WEEX_CATEGORY = "com.kunion.android.intent.category.WEEX";
    private static final String WEEX_ACTION = "com.kunion.android.intent.action.WEEX";
